...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Vox Dei Studio - Learn about our service agreements, intellectual property rights, and policies.",
};
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using Vox Dei Studio's website and services, you
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              All content, designs, code, logos, and materials on our website
              are owned by Vox Dei Studio or our licensors and protected by
              intellectual property laws.
            </p>

            <h3 className="text-xl font-semibold mb-3">Client Projects:</h3>
            <p className="text-muted-foreground mb-3 leading-relaxed">
              Ownership of deliverables will be specified in individual project
              agreements. Generally:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                Clients receive rights to final approved deliverables upon full
                payment
              </li>
              <li>
                We retain rights to preliminary concepts, processes, and
                methodologies
              </li>
              <li>
                We may showcase completed work in our portfolio unless otherwise
                agreed
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-3">
              Specific projects are governed by separate agreements that
              outline:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              We strive to deliver high-quality work that meets agreed
              specifications.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                We do not guarantee specific business results from our services
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                We are not responsible for losses due to circumstances beyond
                our control
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Provisions intended to survive (IP, confidentiality, liability)
                remain in effect
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Legal proceedings will be conducted in accordance with
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              changes will be notified via email or website notice. Continued
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              These terms, together with specific project agreements and our
